	...
	class podPressAdmin_class extends podPress_class
	{
		...
		function settings_feed_edit() {
			...
			*/
			...
			echo '					<br/>';
			echo '					<input name="rss_category" type="text" id="rss_category" value="'.htmlentities($this->settings['rss_category'], ENT_QUOTES, $blog_charset).'" size="45%" />'."\n";
			...
			echo '					<br/>';
			echo '					<input name="rss_copyright" type="text" id="rss_copyright" value="'.htmlentities($this->settings['rss_copyright'], ENT_QUOTES, $blog_charset).'" size="65%" />'."\n";
			...
			echo '					<br/>';
			echo '					<input name="rss_license_url" type="text" id="rss_license_url" value="'.htmlentities($this->settings['rss_license_url'], ENT_QUOTES, $blog_charset).'" size="65%" />'."\n";
