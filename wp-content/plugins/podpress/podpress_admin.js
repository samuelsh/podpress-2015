...
function podPressSetMediaFileValues (VarNum) {
	...
	//BB Dev: document.getElementById('podPressMedia_'+VarNum+'_previewImage').value = data['previewImage'];
	//BB Dev: document.getElementById('podPressMedia_'+VarNum+'_disablePlayer').checked = data['disablePlayer'];
...
function podPressAdjustMediaFieldsBasedOnType(VarNum) {
 ...
 if(typeOfMedia == 'video_'){
		//BB Dev: document.getElementById('podPressMediaPreviewImageWrapper_'+VarNum).style.display='';
		document.getElementById('podPressMediaDimensionWrapper_'+VarNum).style.display='';
		podPressShowPreviewImage(VarNum);
 } else if(typeOfMedia == 'embed_') {
		//BB Dev: document.getElementById('podPressMediaPreviewImageWrapper_'+VarNum).style.display='';
		//BB Dev: document.getElementById('podPressMediaPreviewImageDisplayWrapper_'+VarNum).style.display='';
		...
		//BB Dev: document.getElementById('podPressMediaPreviewImageWrapper_'+VarNum).style.display='none';
		//BB Dev: document.getElementById('podPressMediaPreviewImageDisplayWrapper_'+VarNum).style.display='none';
		document.getElementById('podPressMediaDimensionWrapper_'+VarNum).style.display='none'; 	
 }
}
