	...
	class podPressAdmin_class extends podPress_class
	{
		...
		function settings_feed_edit() {
			...
			*/
			...
			echo '					<br/>';
			echo '					<input name="iTunes[FeedID]" id="iTunesFeedID" type="text" value="'.htmlentities($this->settings['iTunes']['FeedID'], ENT_QUOTES, $blog_charset).'" size="10" />';
			...
			echo '					<br/>';
			echo '					<input type="text" id="podcastFeedURL" name="podcastFeedURL" size="40" value="'.htmlentities(stripslashes($this->settings['podcastFeedURL']), ENT_QUOTES, $blog_charset).'" onchange="podPress_updateFeedSettings();" /><br />'.__('The RSS Feed URL to your podcast.', 'podpress');
			echo '				</td>'."\n";
			echo '			</tr>'."\n";
			...
			echo '					<br/>';
			echo '					<textarea id="iTunesSummary" name="iTunes[summary]" rows="4" cols="40" onchange="podPress_updateFeedSettings();">'.htmlentities($this->settings['iTunes']['summary'], ENT_QUOTES, $blog_charset).'</textarea>';
			...
			echo '					<br/>';
			echo '					<input name="iTunes[author]" type="text" id="iTunesAuthor" value="'.htmlentities($this->settings['iTunes']['author'], ENT_QUOTES, $blog_charset).'" size="40" onchange="podPress_updateFeedSettings();"/>';
			echo '				</td>'."\n";
			echo '				<td width="50%">';
			...
			echo '					<br/>';
			echo '					<textarea name="iTunes[subtitle]" id="iTunesSubtitle" rows="4" cols="40">'.htmlentities($this->settings['iTunes']['subtitle'], ENT_QUOTES, $blog_charset).'</textarea>';
			...
			echo '					<br/>';
			echo '					<textarea name="iTunes[keywords]" id="iTunesKeywords" rows="4" cols="40">'.htmlentities($this->settings['iTunes']['keywords'], ENT_QUOTES, $blog_charset).'</textarea>';
			...
			echo '						<option value="yes" '; if(isset($this->settings['rss_showlinks']) && $this->settings['rss_showlinks'] == 'yes') { echo 'selected="selected"'; } echo '>'.__('Yes', 'podpress').'</option>'."\n";
			echo '						<option value="no" '; if(!isset($this->settings['rss_showlinks']) || $this->settings['rss_showlinks'] != 'yes') { echo 'selected="selected"'; }  echo '>'.__('No', 'podpress').'</option>'."\n";
			echo '					</select>'."\n";
			...
			podPress_itunesCategoryOptions(htmlentities(isset($this->settings['iTunes']['category'][0]) ? 
					$this->settings['iTunes']['category'][0]:"", ENT_QUOTES, $blog_charset));
			echo '					</select>'."\n";
			echo '					<select name="iTunes[category][1]">'."\n";
			echo '						<option value="#">'.__('Select Second', 'podpress').'</option>'."\n";
			podPress_itunesCategoryOptions(htmlentities(isset($this->settings['iTunes']['category'][1]) ?
					$this->settings['iTunes']['category'][1]:"", ENT_QUOTES, $blog_charset));
			echo '					</select>'."\n";
			echo '					<select name="iTunes[category][2]">'."\n";
			echo '						<option value="#">'.__('Select Third', 'podpress').'</option>'."\n";
			podPress_itunesCategoryOptions(htmlentities(isset($this->settings['iTunes']['category'][2]) ?
					$this->settings['iTunes']['category'][2]:"", ENT_QUOTES, $blog_charset));
			echo '					</select>'."\n";
			echo '				</td>'."\n";
			echo '				<td width="50%">'."\n";
			echo '					<label for="rss_category"><strong>'.__('RSS Category', 'podpress').'</strong></label>';
			echo '					<br/>';
			echo '					<input name="rss_category" type="text" id="rss_category" value="'.htmlentities(isset($this->settings['rss_category']) ? 
					$this->settings['rss_category']:"", ENT_QUOTES, $blog_charset).'" size="45%" />'."\n";
			...
			echo '					<br/>';
			echo '					<input name="rss_copyright" type="text" id="rss_copyright" value="'.htmlentities(isset($this->settings['rss_copyright']) ? 
					$this->settings['rss_copyright']:"", ENT_QUOTES, $blog_charset).'" size="65%" />'."\n";
			...
			echo '					<br/>';
			echo '					<input name="rss_license_url" type="text" id="rss_license_url" value="'.htmlentities(isset($this->settings['rss_license_url']) ? 
					$this->settings['rss_license_url']:"", ENT_QUOTES, $blog_charset).'" size="65%" />'."\n";
			...
			echo '						<option value="No" '; if(!isset($this->settings['iTunes']['block']) || $this->settings['iTunes']['block'] != 'Yes') { echo 'selected="selected"'; } echo '>'.__('No', 'podpress').'</option>'."\n";
			echo '						<option value="Yes" '; if(isset($this->settings['iTunes']['block']) && $this->settings['iTunes']['block'] == 'Yes') { echo 'selected="selected"'; } echo '>'.__('Yes', 'podpress').'</option>'."\n";
			echo '					</select>'."\n";
			...
			echo '						<option value="No" '; if(!isset($this->settings['protectFeed']) || $this->settings['protectFeed'] != 'Yes') { echo 'selected="selected"'; } echo '>'.__('No', 'podpress').'</option>'."\n";
			echo '						<option value="Yes" '; if(isset($this->settings['protectFeed']) && $this->settings['protectFeed'] == 'Yes') { echo 'selected="selected"'; } echo '>'.__('Yes', 'podpress').'</option>'."\n";
			echo '					</select>'."\n";
