...
*/
	...
	<input type="button" name="ResetColors" value="Reset Colors to Defaults" onclick="javascript: podPress_colorReset();" />
			...
			echo '				<td valign="top">'."\n";
			echo '					<input valign="top" type="checkbox" name="playerSettings[listenWrapper]" id="playerSettings_listenWrapper" '; if(isset($this->settings['player']['listenWrapper']) && $this->settings['player']['listenWrapper']) { echo 'checked="checked"'; } echo " onclick=\"javascript: podPressShowHideDiv('podPressPlayerSpace_1');\"/>\n";
			echo '				</td>'."\n";
			echo '				<td valign="top">'."\n";
...
BB Dev*/			
			echo '		</table>'."\n";
			echo '<script type="text/javascript"><!--'."\n";
			echo "	document.getElementById('podPressPlayerSpace_2').innerHTML = podPressGenerateVideoPreview (2, '', 320, 267, '".$this->settings['videoPreviewImage']."', true);\n"; //BB Dev
			echo "--></script>\n";
			echo '	</fieldset>'."\n";
			echo '	<fieldset class="options">'."\n";
